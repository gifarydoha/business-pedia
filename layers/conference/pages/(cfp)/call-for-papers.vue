...
<template>
  <div class="mx-auto max-w-7xl px-6 py-12 lg:py-16">
    ...
    <div v-else-if="error || !cfpData" class="py-20 text-center font-poppins text-gray-500">
      Unable to load Call for Papers content right now. Please try again shortly.
    </div>

    <div v-else class="items-start lg:grid lg:grid-cols-[1fr_260px] lg:gap-14">
