  ...
  >
    <div class="p-6 md:p-8">
      <div class="flex flex-col gap-8 md:flex-row md:items-start md:justify-between">
        <!-- Content (Left Side) -->
        <div class="text-brand-footer min-w-0 flex-1 space-y-4 font-poppins text-sm">
          <!-- Title & Code -->
          <h3 class="text-brand-footer font-lora text-lg leading-tight font-semibold">
            <span
          ...
          <div class="grid grid-cols-1 gap-y-3 sm:grid-cols-2 sm:gap-x-6">
            <p class="sm:col-span-2">
              <span class="text-brand-footer font-semibold">By:</span>
              <span class="ml-1 text-brand-primary">{{ paper.authors }}</span>
            </p>

            <p class="sm:col-span-2">
              <span class="text-brand-footer font-semibold">Track:</span> {{ paper.track }}
            </p>
            ...
            <p
              ...
              class="sm:col-span-2"
            >
              <span class="text-brand-footer font-semibold">Keyword:</span>
              <span class="text-brand-footer/80 ml-1">{{ paper.keywords }}</span>
            </p>

            <p>
              <span class="text-brand-footer font-semibold">Status:</span>
              <span class="bg-brand-accent text-brand-accent-foreground ml-1 inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium">
                {{ paper.current_status }}
              </span>
            </p>

            <p>
              <span class="text-brand-footer font-semibold">Final Decision:</span>
              <span
                class="ml-1 inline-flex items-center rounded-full px-2.5 py-0.5 font-lora text-xs font-bold capitalize"
                :class="{
            ...
            <p>
              <span class="text-brand-footer font-semibold">Created Date:</span>
              <span class="text-brand-footer/80 ml-1">{{ paper.created || paper.submittedDate }}</span>
            </p>

            <p>
              <span class="text-brand-footer font-semibold">Last Updated:</span>
              <span class="text-brand-footer/80 ml-1">{{ paper.updated || paper.submittedDate }}</span>
            </p>

            <p class="sm:col-span-2">
              <span class="text-brand-footer font-semibold">Included in the conference proceedings?:</span>
              <span
          ...
          >
            <span class="text-brand-footer mb-3 block font-semibold">Paper (before review):</span>
            <a
              :href="pdfUrl"
              target="_blank"
              class="hover:text-brand-footer inline-flex items-center gap-3 rounded-lg border border-brand-primary/20 bg-brand-primary-light px-4 py-2.5 text-sm font-medium text-brand-primary-dark shadow-sm transition-all hover:bg-brand-primary/20 hover:shadow"
            >
        ...
        <div class="grid w-full shrink-0 grid-cols-2 gap-2 sm:w-64">
          ...
          >
            <Button
              variant="outline"
              size="sm"
              class="w-full justify-start border-brand-primary font-lora text-brand-primary hover:bg-brand-primary hover:text-brand-primary-foreground"
            >
          ...
          >
            <Button
              variant="default"
              size="sm"
              class="w-full justify-start bg-brand-primary font-lora text-brand-primary-foreground hover:bg-brand-primary-dark"
            >
          ...
          >
            <Button
              variant="default"
              size="sm"
              class="w-full justify-start bg-brand-secondary font-lora text-brand-secondary-foreground hover:bg-brand-secondary/80"
            >
          ...
          <template v-if="viewType === 'my-papers'">
            ...
            >
              <Button
                variant="outline"
                size="sm"
                class="w-full justify-start border-brand-primary font-lora text-brand-primary hover:bg-brand-primary-light"
              >
            ...
            >
              <Button
                variant="default"
                size="sm"
                class="w-full justify-start bg-brand-primary-dark font-lora text-white hover:bg-brand-primary"
              >
          ...
          >
            <Button
              variant="outline"
              size="sm"
              class="w-full justify-start border-border font-lora text-foreground hover:bg-muted"
            >
