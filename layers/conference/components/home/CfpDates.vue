...
<template>
  <section id="dates" class="bg-cfp-cream py-20 md:py-28">
    <div class="mx-auto max-w-7xl px-6">
      ...
      <div class="relative hidden md:block">
        ...
        <div class="relative grid grid-cols-5 gap-4">
          <div v-for="(d, i) in dates" :key="i" class="flex flex-col items-center text-center">
            <!-- Dot -->
            <div :class="[
      ...
      <div class="relative pl-8 md:hidden">
        ...
        <div class="flex flex-col gap-8">
          <div v-for="(d, i) in dates" :key="i" class="relative flex items-start gap-4">
            <!-- Dot -->
            <div :class="[
