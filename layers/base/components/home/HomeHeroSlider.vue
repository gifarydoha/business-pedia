...
<template>
  <section v-if="activeSlides.length" class="hero-section overflow-hidden pt-24">
    <div class="mx-auto max-w-7xl px-5 sm:px-8">
      <div class="grid min-h-130 grid-cols-1 items-center gap-10 lg:grid-cols-2">
        <!-- Left: text -->
        <div class="py-10 lg:py-16">
          <div
            class="mb-6 inline-flex items-center gap-2 rounded-full bg-fy-teal-300/10 px-3 py-1.5 font-lora text-xs font-bold text-fy-teal-300">
            <Icon name="lucide:zap" size="12" />
            Personal Growth Platform
          </div>

          <!-- Headline -->
          <h1 :key="`headline-${currentSlide}`"
          ...
          <div class="mb-10 flex flex-wrap items-center gap-4">
            ...
            <NuxtLink to="#"
              ...
              <Icon name="lucide:play" size="14" class="fill-current" />
              Watch intro
            </NuxtLink>
          </div>
          ...
          <div class="mb-10 flex items-center gap-2.5">
            <button v-for="(_, i) in activeSlides" :key="i"
              class="hero-dot h-2 cursor-pointer rounded-full transition-all duration-300" :style="{
                width: i === currentSlide ? '28px' : '8px',
                background: i === currentSlide ? slide.accent : 'rgba(0,0,0,0.15)',
              }" :aria-label="`Go to slide ${i + 1}`" @click="go(i)" />
            ...
            <div class="flex flex-wrap items-center gap-4 lg:gap-6">
              <div class="flex items-center gap-2">
                <div class="flex -space-x-2">
                  <div v-for="(src, i) in TRUST_AVATARS" :key="i"
                    class="relative size-8 overflow-hidden rounded-full border-2 border-white">
                    <NuxtImg :src="src" alt="learner" class="size-full object-cover" sizes="32px" />
                  </div>
                </div>
              ...
              <div class="flex items-center gap-1.5">
                <span class="flex items-center gap-0.5">
                  <Icon v-for="i in 5" :key="i" name="lucide:star" size="13"
              ...
              <div class="flex items-center gap-1.5">
                <Icon name="lucide:award" size="14" class="text-fy-orange-300" />
                <span class="font-poppins text-xs text-fy-slate-400">
        ...
        <div class="relative hidden h-full min-h-100 items-end justify-center pb-0 lg:flex">
          ...
          <div
            class="hero-floating-card absolute top-16 left-0 flex items-center gap-3 rounded-xl bg-white p-3 shadow-lg">
            <div class="flex size-9 items-center justify-center rounded-xl bg-fy-teal-300/15">
              <Icon name="lucide:check-circle-2" size="18" class="text-fy-teal-300" />
            </div>
            <div>
          ...
          <div class="relative z-10 mx-auto mt-12 w-full max-w-85">
            <div class="overflow-hidden rounded-3xl"
              ...
              <svg viewBox="0 0 320 320" width="100%" height="320" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="160" cy="155" r="108" fill="#12B793" fill-opacity="0.07" />
                <circle cx="160" cy="155" r="75" fill="#12B793" fill-opacity="0.07" />
                <!-- Brain body -->
                <path
                  ...
                  fill="#12B793" fill-opacity="0.18" stroke="#12B793" stroke-width="1.5" />
                <!-- Wrinkles -->
                <path d="M138 115 C143 108 152 106 158 110" stroke="#12B793" stroke-width="1.5"
                  stroke-linecap="round" />
                <path d="M176 112 C182 108 190 110 193 117" stroke="#12B793" stroke-width="1.5"
                  stroke-linecap="round" />
                <path d="M125 148 C130 140 140 138 146 143" stroke="#12B793" stroke-width="1.5"
                  stroke-linecap="round" />
                <path d="M180 143 C185 136 194 134 198 141" stroke="#12B793" stroke-width="1.5"
                  stroke-linecap="round" />
                <path d="M132 172 C136 165 145 163 149 168" stroke="#12B793" stroke-width="1.5"
                  stroke-linecap="round" />
                <path d="M170 168 C175 161 184 160 187 167" stroke="#12B793" stroke-width="1.5"
                  stroke-linecap="round" />
                <!-- Centre split -->
                <line x1="160" y1="88" x2="160" y2="218" stroke="#12B793" stroke-width="1" stroke-dasharray="3 4"
                  stroke-opacity="0.35" />
                <!-- Growth arrow -->
                <path d="M160 228 L160 260 M149 240 L160 228 L171 240" stroke="#F4701B" stroke-width="2.5"
                  stroke-linecap="round" stroke-linejoin="round" />
                <!-- Orbiting dots -->
                <circle cx="94" cy="108" r="4.5" fill="#F4701B" fill-opacity="0.6" />
                <circle cx="228" cy="98" r="3.5" fill="#236D86" fill-opacity="0.7" />
                <circle cx="82" cy="192" r="5.5" fill="#12B793" fill-opacity="0.4" />
                <circle cx="240" cy="188" r="4" fill="#F4701B" fill-opacity="0.5" />
                <circle cx="105" cy="56" r="3" fill="#12B793" fill-opacity="0.5" />
                <circle cx="222" cy="62" r="2.5" fill="#F4701B" fill-opacity="0.4" />
                <!-- Sparkle lines -->
                <line x1="66" y1="145" x2="76" y2="145" stroke="#12B793" stroke-width="1.5" stroke-linecap="round"
                  stroke-opacity="0.5" />
                <line x1="71" y1="140" x2="71" y2="150" stroke="#12B793" stroke-width="1.5" stroke-linecap="round"
                  stroke-opacity="0.5" />
                <line x1="254" y1="145" x2="244" y2="145" stroke="#F4701B" stroke-width="1.5" stroke-linecap="round"
                  stroke-opacity="0.5" />
                <line x1="249" y1="140" x2="249" y2="150" stroke="#F4701B" stroke-width="1.5" stroke-linecap="round"
                  stroke-opacity="0.5" />
              </svg>
            </div>
            ...
            <div
              ...
              <div>
                ...
                <div class="flex gap-1">
                  <div v-for="(d, i) in ['M', 'T', 'W', 'T', 'F', 'S', 'S']" :key="d + i"
                    class="flex flex-col items-center gap-1">
                    <div class="size-5 rounded-md" :style="{ background: i < 5 ? '#F4701B' : 'rgba(0,0,0,0.08)' }" />
    ...
    <!-- Wave divider -->
    <svg viewBox="0 0 1440 60" preserveAspectRatio="none" class="-mt-px block h-15 w-full">
      <path d="M0,30 C360,60 1080,0 1440,30 L1440,60 L0,60 Z" fill="#f0f7f5" />
    </svg>
  </section>
</template>
