      ...
      >
        <div>
          ...
          <input
            ...
            v-model="email"
            type="email"
            class="w-full rounded-lg border border-slate-300 bg-white px-3 py-2.5 font-lora text-sm focus:border-fy-teal-300 focus:ring-2 focus:ring-fy-teal-300 focus:outline-none"
          >
          <p
            v-if="errors.email"
